...
public unsafe struct AtkDragDropManager
{
    ...
    // Points to AtkDragDropInterface* within the dragged AtkComponentDragDrop
    [FieldOffset(0x98)] public AtkDragDropInterface* UnkDragDrop_1;

    // vvv Not set in some cases where DragDropS isn't used (like with hotbars)
    [FieldOffset(0xA0)] public AtkDragDropInterface* UnkDragDrop_2;
